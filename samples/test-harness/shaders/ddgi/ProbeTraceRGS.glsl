...
// #include "../include/Lighting.glsl" // TODO
...
void main() {
    ...
    int rayIndex = gl_LaunchIDEXT.x;                    // index of the ray to trace for this probe
    int probePlaneIndex = gl_LaunchIDEXT.y;             // index of this probe within the plane of probes
    int planeIndex = gl_LaunchIDEXT.z;                  // index of the plane this probe is part of
    ...
    vec3 probeCoords = DDGIGetProbeCoords(probeIndex, volume);
